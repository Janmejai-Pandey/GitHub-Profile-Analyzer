...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#080811] text-white relative overflow-hidden flex flex-col justify-between selection:bg-purple-500 selection:text-white">
      ...
      {/* 1. Clean Header */}
      <header className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 py-4 sm:py-6 flex items-center justify-between border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <div className="bg-white/10 p-1 rounded-lg backdrop-blur-md border border-white/10 flex items-center justify-center">
            ...
            <img src="/favicon.ico" alt="GHOST logo" className="w-6 h-6" />
          </div>
          <span className="font-black text-2xl tracking-tight bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
            GHOST
          </span>
        </div>
      </header>
      ...
      <main className="relative z-10 max-w-4xl mx-auto w-full px-4 text-center my-auto py-8 sm:py-12">
        {/* Version Badge */}
        <div className="hidden inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.04] border border-white/10 text-xs font-mono text-gray-300 mb-6 sm:mb-8 backdrop-blur-md">
            ...
            <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center bg-[#0d0d1a]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-2 shadow-2xl gap-2 sm:gap-0">
              <div className="flex items-center flex-1 px-1">
                ...
                <input
                  ...
                  className="w-full bg-transparent text-white placeholder-gray-500 text-sm focus:outline-none py-1.5"
                />
              </div>
      ...
      <footer className=" hidden relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500 border-t border-white/5">
        <div>
